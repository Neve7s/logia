...
export const SITE_CONTENT = {
  ...
  pricing: {
    ...
    plans: [
      ...
      },
      {
        name: "Estándar",
        basePrice: 149.99,
        description: "Para agencias que necesitan control total de operaciones. Shipments, tracking y reclutamiento integrado.",
        features: [
          "Todo en Básico",
          ...
          "Envíos de email automáticos a clientes",
  ...
  navbar: {
    solutions: [
      { icon: "fa-calculator", label: "Cotizador Pro", path: "/app/cotizador" },
      { icon: "fa-box-open", label: "Shipments Control", path: "/app/shipments" },
      { icon: "fa-file-invoice", label: "Facturación SUNAT", path: "/app/facturacion" },
  ...
  footer: {
    ...
    solutions: [
      ...
      { icon: "fas fa-calculator", label: "Cotizador Pro", path: "/app/cotizador" },
      { icon: "fas fa-box-open", label: "Shipments", path: "/app/shipments" },
      { icon: "fas fa-file-invoice", label: "Facturación SUNAT", path: "/app/facturacion" },
